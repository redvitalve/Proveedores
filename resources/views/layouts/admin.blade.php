...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ 'Proveedores - redvital®' }}</title>
                                                                ...
                                                                <div class="card-footer bg-c-purple">
                                                                    <div class="row align-items-center">
                                                                        ...
                                                                        <div class="text-right col-3">
                                                                            <i class="text-white fa fa-line-chart f-16"></i>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <table class="table table-hover">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <div class="align-middle d-inline-block">
                                                                                        <img src="assets/images/avatar-4.jpg" alt="user image" class="align-top img-radius img-40 m-r-15">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <div class="align-middle d-inline-block">
                                                                                        <img src="assets/images/avatar-5.jpg" alt="user image" class="align-top img-radius img-40 m-r-15">
                                                                                        <div class="d-inline-block">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <div class="align-middle d-inline-block">
                                                                                        <img src="assets/images/avatar-3.jpg" alt="user image" class="align-top img-radius img-40 m-r-15">
                                                                                        <div class="d-inline-block">
                                                                                            <h6>William Jem</h6>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <div class="align-middle d-inline-block">
                                                                                        <img src="assets/images/avatar-2.jpg" alt="user image" class="align-top img-radius img-40 m-r-15">
                                                                                        <div class="d-inline-block">
                                                                                            <h6>David Jones</h6>
                                                                                            <p class="text-muted m-b-0">Developer</p>
                                                                                        </div>
                                                        ...
                                                        <div class="col-xl-4 col-md-12">
                                                            <div class="card ">
                                                                ...
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="align-middle m-b-30">
                                                                        <img src="assets/images/avatar-1.jpg" alt="user image" class="align-top img-radius img-40 m-r-15">
                                                                        <div class="d-inline-block">
                                                                            <h6>David Jones</h6>
                                                                            <p class="text-muted m-b-0">Developer</p>
                                                                        </div>
