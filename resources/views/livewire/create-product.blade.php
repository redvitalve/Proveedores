      ...
      <x-slot name="content">
          {{-- <form action="{{route('dashboard')}}" method="post" encrypted="multipart/form-data" class="w-full max-w-lg">
              ...
              <div class="flex flex-wrap">
                    <input type="file" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-6 px-6 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" wire:model="imagen">
              </div>
          {{-- </form> --}}
      </x-slot>
